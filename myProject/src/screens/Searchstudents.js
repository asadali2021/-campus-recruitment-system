...
const SearchStudents = (props) => {
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <Text style={{marginTop:10,fontSize: 15, marginLeft:10, color:'#dfe4ea',}}> Post A Job</Text>
      </TouchableOpacity>
      <TouchableOpacity style={{
        backgroundColor:'#1e90ff', 
        width:100,
      ...
      <Text style={{marginTop:10,fontSize: 15, marginLeft:10, color:'#dfe4ea',}}> Logout</Text>
      </TouchableOpacity>
      </View>
        <TextInput
